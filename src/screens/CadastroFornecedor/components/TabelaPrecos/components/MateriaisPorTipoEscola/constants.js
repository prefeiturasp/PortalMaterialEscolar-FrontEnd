export const TIPO_ESCOLA_MATERIAIS = {
  educacao_infantil: {
    ...
    materiais: [
      ...
      },
      {
        ...
        value: "caneta hidrografica_12_cores",
        quantidade: 1,
      },
      {
        label: "Cola Branca",
      ...
      },
      {
        ...
        value: "giz_de_cera_grosso_educacao_infantil",
        quantidade: 1,
      },
      {
  ...
  ensino_fundamental_alfabetizacao: {
    ...
    materiais: [
      ...
      {
        label: "Caderno brochurrão 80 Fls",
        value: "caderno_brochurrao_80_fls",
        quantidade: 4,
      },
      {
        label: "Caderno de desenho 96 Fls",
      ...
      },
      {
        ...
        value: "giz_de_cera_ensino_fundamental",
        quantidade: 1,
      },
      {
        label: "Lápis de cor (12 cores)",
