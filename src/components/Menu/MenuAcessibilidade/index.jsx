...
export const MenuAcessibilidade = ({ handleFonte, handleConstraste }) => {
  return (
    <div>
              ...
              <ul className="list-inline mt-3">
                <li className="list-inline-item">
                  <a href="https://educacao.sme.prefeitura.sp.gov.br/acessibilidade/">
                    Acessibilidade<span className="span-accesskey">4</span>{" "}
                  </a>
                </li>
                <li onClick={handleConstraste} className="list-inline-item">
                  Alternar Alto Contraste
                  <FontAwesomeIcon icon={faAdjust} />
                </li>
                <li onClick={handleFonte} className="list-inline-item">
